...
const BootcampSchema = new mongoose.Schema(
  {
    ...
    // name with all lower case charecters
    slug: String,
    description: {
      type: String,
      required: [true, "Please add deescrption"],
    ...
    phone: {
      type: String,
      maxlength: [20, "Phone number cannot be longer than 20 characcters"],
    },
    email: {
      type: String,
      match: [
...
// create bootcamp slug from name-- Look for mongoose middleware documentation pre section
